...
# train = open('bdd100k_labels_images_val.json')
train_label_file = json.load(train)
print(len(train_label_file))

# val = open('bdd100k_labels_images_val.json')
# val_label_file = json.load(val)
# print(len(val_label_file))
...
plot1 = Plotting()
plot1.add_subplot(plot_dict, 'Distribution of instances in whole dataset') 
...
plot2 = Plotting()
plot2.add_subplot(plot_dict, 'Distribution of weather') 
...
plot3 = Plotting()
plot3.add_subplot(plot_dict, 'Distribution of Scene') 
...
plot4 = Plotting()
plot4.add_subplot(plot_dict, 'Distribution of time of day')


plot5 = Plotting()
plot5.add_subplot(truncated_dict, 'Distribution of Truncated')


plot6 = Plotting()
plot6.add_subplot(occlusion_dict, 'Distribution of Occlusion')
