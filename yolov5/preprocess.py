...
train_image_load = 'dataset/bdd100k/images/train/'
val_image_load = 'dataset/bdd100k/images/val/'

train_labels_load = 'dataset/bdd100k/labels/train/'
val_labels_load = 'dataset/bdd100k/labels/val/'
...
main_file = open("dataset/bdd100k/val_dawn_dusk_bdd100k.txt", "w")
...
for file in json_label_file:
    if file['attributes']['timeofday'] == 'dawn/dusk':
